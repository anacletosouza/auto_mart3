"""
Description:
This script processes XVG files containing molecular simulation data for bonds, angles, and dihedrals. 
It compares reference and simulated datasets by generating both distribution plots (using Kernel Density Estimation) 
and time series plots. The script automatically organizes outputs into structured directories and supports batch 
processing of multiple indexed files.

Key features include:
- Reading and parsing XVG files (ignoring comments and metadata)
- Extracting time series or reconstructing distributions from histogram data
- Generating smooth probability density curves using Gaussian KDE
- Plotting:
    * Combined (reference vs simulated) distributions
    * Separate distributions for each dataset
    * Combined and separate time series plots
- Automatic directory creation for organized output
- Command-line argument support for flexible input/output paths
- Memory-efficient plotting with figure cleanup

This tool is useful for validating molecular dynamics simulations by comparing structural properties 
between reference and simulated systems.
...
python script.py \
    ...
    --angles_ref_dir angles_ref \
    --angles_sim_dir angles_sim \
    --dihedrals_ref_dir dihedrals_ref \
    --dihedrals_sim_dir dihedrals_sim \
...
figures_output/
    bonds/
        ...
        distr_ref_simulated_separated/ref/
        distr_ref_simulated_separated/simulated/
        time_series_ref_simulated_joined/
        time_series_ref_simulated_separated/ref/
        time_series_ref_simulated_separated/simulated/
    angles/
        ...
    dihedrals/
        ...

Each folder will contain PNG and SVG plots comparing reference and simulated data for each index.
...
# ============================================
# Plot style configuration (constantes globais OK)
# ============================================
...
# ============================================
# Helper functions (mantenha todas as funções auxiliares)
# ============================================
...
# ============================================
# Main function (agora com o parser aqui!)
# ============================================
...
def main():
    ...
    # ============================================
    # Argument parser (movido para dentro da função main)
    # ============================================
...
# ============================================
# Run main function (apenas quando executado diretamente)
# ============================================
