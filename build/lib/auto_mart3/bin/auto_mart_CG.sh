...
#     --dt_md_ps <float>                MD production timestep in ps (default: 0.002)
...
for i in $(seq 1 $N_ITER); do
    ...
    gmx grompp -f minimization.mdp -p md.gro -c "$SOLV_IONS_GRO" -o em.tpr -r "$SOLV_IONS_GRO" -maxwarn 2
    gmx mdrun -v -deffnm em -ntmpi $NTMPI -ntomp $NTOMP
